...
-- Takes a list and double every second elements
doubleSecond :: [Integer] -> [Integer]
doubleSecond (x:y:xs) = x : (double y) : doubleSecond xs
doubleSecond (x:  xs) = [x]
doubleSecond []       = []

-- sum all the digits of a given sequence of integers. If an element e >= 10, then the digits of e
-- is summed
...
isValid cn = (sumDigits . doubleSecond . toDigitsRev $ cn) `mod` 10 == 0
